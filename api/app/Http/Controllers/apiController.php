...
{
    public function ticketParEntiter($date1, $date2)
    {
    ...
    public function satisfactionByTechnicien($date1, $date2)
    {
        $date1 = date('Y/m/d', strtotime($date1));
        $date2 = date('Y/m/d', strtotime($date2));
    ...
    public function ticketByTechnicien($date1, $date2)
    {
        $date1 = date('Y/m/d', strtotime($date1));
        $date2 = date('Y/m/d', strtotime($date2));
    ...
    public function satisfactionByEntiter($date1, $date2)
    {
        $date1 = date('Y/m/d', strtotime($date1));
        $date2 = date('Y/m/d', strtotime($date2));
    ...
    public function ticketResoluByEntiter($date1, $date2)
    {
        $date1 = date('Y/m/d', strtotime($date1));
        $date2 = date('Y/m/d', strtotime($date2));
    ...
    public function totaleTikets($date1, $date2)
    {
        $date1 = date('Y/m/d', strtotime($date1));
        $date2 = date('Y/m/d', strtotime($date2));
